    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-lavender-100 text-gray-700 font-medium rounded-xl hover:bg-lavender-200 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
        >
          <span>??</span>
